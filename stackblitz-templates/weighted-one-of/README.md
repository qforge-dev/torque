# Torque Weighted oneOf Example - Interactive Playground

Demonstrates mixing explicit weights and automatically distributed weights when selecting between schema branches.
