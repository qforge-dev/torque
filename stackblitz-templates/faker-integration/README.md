# Torque Faker Integration Example - Interactive Playground

that automatically respects the seed system for reproducible datasets. Faker is useful for: - Creating realistic user personas with names, emails, addresses - Generating sample data for testing (product names, prices, dates) - Adding variety to prompts without manually writing examples
